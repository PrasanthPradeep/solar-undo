  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-20 right-6 z-45 flex items-center gap-2 px-4 py-3 bg-card border border-border rounded-full shadow-lg hover:shadow-xl transition-all duration-300 group cursor-pointer hover:-translate-y-0.5 active:translate-y-0"
